function [img_CF] = PixelIntOverTau(img_FLIM, img_Counts, Tau_edges, Int_edges,int_Thresh, Max_Counts,  Max_Tau , Title_t)
%%function [img_CF] = PixelIntOverTau(img_FLIM, img_Counts, Tau_edges, Int_edges,int_Thresh, Max_Counts,  Max_Tau , Title_t)
%%
...
% figure
    subplot(2,2,2)
        ...
        IntTau(img_Counts,img_FLIM/1000, [int_Thresh Max_Counts/4],[0.1 1], []);
    ...
    subplot(223)
        ...
        hi = imagesc(Tau_edges,Int_edges, img_CF') ; %colorbar
        mask_CF = double(img_CF>0);
        set(hi, 'AlphaData', rescaleData( mask_CF', [0 1]));
        set(gca, 'Color', [0 0 0]);
