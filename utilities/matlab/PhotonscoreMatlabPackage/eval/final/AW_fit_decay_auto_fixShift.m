function [x, m] = AW_fit_decay_auto_fixShift(r, d, exps, varargin)
...
addParameter(ip, 'irf_shift', irf_shift);
addParameter(ip, 'fixIrf_shift', 0);
parse(ip, r, d, exps, varargin{:});
p = ip.Results;

bg = p.bg;
tau_ref = p.tau_ref;
irf_shift =p.irf_shift; 
% First trial
...
if p.fixIrf_shift
    ...
    xl.irf_shift = x0.irf_shift-4;
    xu.irf_shift = x0.irf_shift+4;
end
